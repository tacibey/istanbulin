function showCopyNotification() {
    // ... (kod aynı, okunabilirlik için küçültüldü)
}
...
document.addEventListener('DOMContentLoaded', () => {
    // PWA Kurulumu (sadece telefona ekle)
    function setupPWA() {
        ...
        const t=document.getElementById("install-button");let o;window.addEventListener("beforeinstallprompt",e=>{e.preventDefault(),o=e,t&&t.classList.add("visible")}),t&&t.addEventListener("click",async()=>{o&&(t.classList.remove("visible"),o.prompt(),await o.userChoice,o=null)}),window.addEventListener("appinstalled",()=>{o=null,t&&t.classList.remove("visible")})
    }
    setupPWA();
    ...
    // --- Harita Kurulumu (değişti) ---
    const map = L.map('map', {
        attributionControl: false,
        layers: [] // Başlangıçta katman ekleme, tema fonksiyonu ekleyecek
